...
![Integration Tests](https://github.com/step-security/file-changes-action/workflows/Integration%20Tests/badge.svg)
...
jobs:
  changes:
    ...
    steps:
      - id: file_changes
        uses: step-security/file-changes-action@v1
    ...
    steps:
      - id: file_changes
        ...
        with:
          ...
          githubRepo: step-security/file-changes-action
          # optional token
