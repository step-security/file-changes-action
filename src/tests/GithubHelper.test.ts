            ...
            JSON.stringify(
              {
                ...
                message:
                  'There was an error getting change files for repo:step-security/file-changes-action owner:error pr:error',
            ...
            JSON.stringify(
              {
                ...
                from: 'getChangedPRFiles',
                message:
                  'There was an error getting change files for repo:step-security/file-changes-action owner:unknown pr:unknown',
                payload: ''
              },
              null,
              2
            ...
            JSON.stringify(
              {
                ...
                message:
                  'There was an error getting change files for repo:step-security/file-changes-action owner:error base:error head:error',
                payload: JSON.stringify({name: 'HttpError', status: '500'})
              },
              null,
              2
            ...
            JSON.stringify(
              {
                ...
                from: 'getChangedPushFiles',
                message:
                  'There was an error getting change files for repo:step-security/file-changes-action owner:unknown base:unknown head:unknown',
                payload: ''
              },
              null,
              2
