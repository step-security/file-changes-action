...
export const getChangedPRFilesTestInputs: TestInput[] = [
  {
    inputs: [
      ...
      {owner: 'step-security', repo: 'file-changes-action', pullNumber: 83},
  ...
  },
  {
    inputs: [
      ...
      {owner: 'step-security', repo: 'file-changes-action', pullNumber: NaN},
      {
        error: '404/HttpError',
        from: 'getChangedPRFiles',
        message:
          'There was an error getting change files for repo:file-changes-action owner:step-security pr:NaN',
  ...
  },
  {
    inputs: [
      ...
      },
      {
        ...
        from: 'getChangedPRFiles',
        message:
          'There was an error getting change files for repo:file-chandkdk-action-thatdoesntreallyexist owner:step-security pr:83',
        payload: {name: 'HttpError', status: '404'}
      }
    ],
    events: 'all'
  ...
  },
  {
    inputs: [
      ...
      },
      {
        ...
        message:
          'There was an error getting change files for repo:file-changes-action owner:step-security base: head:4ee1a1a2515f4ac1b90a56aaeb060b97f20c8968',
        payload: {name: 'HttpError', status: '404'}
      }
    ],
    events: 'all'
  },
  {
    inputs: [
      ...
      },
      {
        ...
        from: 'getChangedPushFiles',
        message:
          'There was an error getting change files for repo:file-changes-action owner:step-security base:6ac7697cd1c4f23a08d4d4edbe7dab06b34c58a2 head:',
        payload: {name: 'HttpError', status: '404'}
      }
    ],
    events: 'all'
  },
  {
    inputs: [
      ...
      },
      {
        ...
        from: 'getChangedPushFiles',
        message:
          'There was an error getting change files for repo:file-chandkdk-action-thatdoesntreallyexist owner:step-security base:6ac7697cd1c4f23a08d4d4edbe7dab06b34c58a2 head:4ee1a1a2515f4ac1b90a56aaeb060b97f20c8968',
        payload: {name: 'HttpError', status: '404'}
      }
    ],
    events: 'all'
...
export const getChangedFilesTestInputs: TestInput[] = [
  {
    inputs: [
      'gets changed files for a push',
      {
        repo: 'step-security/file-changes-action',
        ...({
          before: '6ac7697cd1c4f23a08d4d4edbe7dab06b34c58a2',
          after: '4ee1a1a2515f4ac1b90a56aaeb060b97f20c8968'
        } as Inferred)
  ...
  },
  {
    inputs: [
      ...
      {
        repo: 'step-security/testing/afew/backslash',
        ...({
          before: '6ac7697cd1c4f23a08d4d4edbe7dab06b34c58a2',
          after: '4ee1a1a2515f4ac1b90a56aaeb060b97f20c8968'
        } as Inferred)
        ...
        payload: JSON.stringify(
          {
            ...
            from: 'self',
            message:
              'Repo input of step-security/testing/afew/backslash has more than 2 length after splitting.',
            payload: ''
          },
          null,
          2
  ...
  },
  {
    inputs: [
      'throws an error with invalid owner for a push',
      {
        repo: 'step-security-NOTREAL/backslash',
        ...({
          before: '6ac7697cd1c4f23a08d4d4edbe7dab06b34c58a2',
          after: '4ee1a1a2515f4ac1b90a56aaeb060b97f20c8968'
        } as Inferred)
      },
      {
        ...
        message:
          'There was an error getting change files for repo:backslash owner:step-security-NOTREAL base:6ac7697cd1c4f23a08d4d4edbe7dab06b34c58a2 head:4ee1a1a2515f4ac1b90a56aaeb060b97f20c8968',
        payload: {name: 'HttpError', status: '404'}
      }
    ],
    events: 'all'
  },
  {
    inputs: [
      'throws an error with no after for a push',
      {
        repo: 'step-security/cloudformation',
      ...
      },
      {
        ...
        from: 'undefined/Error',
        message:
          'There was an error getting change files for repo:cloudformation owner:step-security base:6ac7697cd1c4f23a08d4d4edbe7dab06b34c58a2 head:',
        payload: {name: 'HttpError', status: '404'}
      }
    ],
    events: 'all'
  },
  {
    inputs: [
      ...
      },
      {
        ...
        from: 'undefined/Error',
        message:
          'There was an error getting change files for repo:cloudformation owner:step-security base: head:4ee1a1a2515f4ac1b90a56aaeb060b97f20c8968',
        payload: {name: 'HttpError', status: '404'}
      }
    ],
    events: 'all'
  },
  {
    inputs: [
      'gets changed files for a pull request',
      {repo: 'step-security/file-changes-action', ...({pr: 83} as Inferred)},
      p.OctokitPaginatePrResponse
    ],
    events: 'all'
  },
  {
    inputs: [
      ...
      {repo: 'step-security/testing/afew/backslash', ...({pr: 83} as Inferred)},
      {
        error: '500/Unknown Error:Error',
        from: 'getChangedFiles',
        message:
  ...
  },
  {
    inputs: [
      ...
      {repo: 'step-security-NOTREAL/backslash', ...({pr: 80} as Inferred)},
      {
        error: '404/HttpError',
        from: 'undefined/Error',
        message:
          'There was an error getting change files for repo:backslash owner:step-security-NOTREAL pr:80',
        payload: {name: 'HttpError', status: '404'}
      }
    ],
    events: 'all'
  },
  {
    inputs: [
      'throws an error with no pull request',
      {repo: 'step-security/cloudformation', ...({} as Inferred)},
      {
        error: '404/HttpError',
        from: 'undefined/Error',
        message:
          'There was an error getting change files for repo:cloudformation owner:step-security base: head:',
        payload: {name: 'HttpError', status: '404'}
      }
    ],
    events: 'all'
...
export const inputTestInputs: TestInput[] = [
  {
    inputs: [
      'githubRepo',
      'step-security-test/file-changes-action',
      'step-security-test/file-changes-action'
    ],
    events: 'all'
  },
